...
export default function AthleteDirectoryPage() {
  ...
  const loading = useSimulatedLoading(400, [currentOrg.id, category])
                ...
                <div className="flex flex-col">
                  {visible.map((athlete, i) => (
                    <Link
                      ...
                      className="group grid animate-fade-in grid-cols-[2fr_1.4fr_1.6fr_1.4fr_0.8fr] items-center gap-3 rounded-xl px-4 py-3 transition-colors hover:bg-hover"
